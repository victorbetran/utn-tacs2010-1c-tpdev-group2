...
public class CancelacionDePedidoTest {
	...
	@Test public void cancelarUnPedidoEnCurso(){
		...
		Assert.assertFalse("El pedido se ha cancelado pero a�n contiene piezas.",this.pedido.tienePiezas());
	}
	...
	/**
	 * Cancela un pedido que hab�a sido cancelado previamente, es decir, un pedido <b>CANCELADO</b>.
	 */
